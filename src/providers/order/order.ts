...
export class OrderProvider {
  ...
  constructor(public http: HttpProvider, @Inject(APP_CONFIG) public config: AppConfig, public events: Events, public appCache:AppCache,//public printProvider: PrintProvider,
