...
import { SysMsg, MSG_KEY_MEDIA, MSG_KEY_HO, MSG_KEY_VIBRATION } from '../domain/sysMsg';
import { SellerDao } from '../dao/sellerDao';
import { UserDao } from '../dao/userDao';
import { Seller } from '../domain/seller';
import { HttpProvider } from './http';
import { DatePipe, DecimalPipe } from '@angular/common';
import { MSG_KEY_DEF, MSG_KEY_ORDER, MSG_KEY_RECHARGE, MSG_KEY_SMS, MSG_KEY_SYS } from '../domain/sysMsg';
...
export class PushProvider {
  ...
  constructor(@Inject(APP_CONFIG) private config: AppConfig,  public nativeProvider: NativeProvider, public events: Events, public appConstants: AppConstants,
