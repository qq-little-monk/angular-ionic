...
export class PrintSetting implements IPrintSetting {
  ...
  tagPrint: string
  tagPrintNum:number
  static tableName: string = 'tb_print_setting';
  static create: string = 'CREATE TABLE IF NOT EXISTS [tb_print_setting] (' +
   ...
   */
  static newColumns = [
    {name: 'receiptPrint_kaitai', alter: 'ALTER TABLE tb_print_setting ADD COLUMN receiptPrint_kaitai VARCHAR2(2)'},
    {name: 'receiptPrintkaitaiNum', alter: 'ALTER TABLE tb_print_setting ADD COLUMN receiptPrintkaitaiNum INTEGER'},
    {name: 'tagPrint', alter: 'ALTER TABLE tb_print_setting ADD COLUMN tagPrint VARCHAR2(2)'},
    {name: 'tagPrintNum', alter: 'ALTER TABLE tb_print_setting ADD COLUMN tagPrintNum INTEGER'}
  ];
