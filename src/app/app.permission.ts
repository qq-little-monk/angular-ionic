...
export class AppPermission {
    ...
    staffPermission(val: string) {
        ...
        // let cashierCommission: string;
        // cashierCommission = this.appShopping.staff.cashierCommission;
        // console.log(this.staff);
        // if (this.appShopping.staff && this.appShopping.staff.cashierCommission && this.appShopping.staff.cashierCommission.length > 0) {
        //     if (this.staff.cashierCommission.indexOf(val) > -1) {
        //         return true;
        //     }
        //     return false;
        // } else {
