...
export class WebSocketService {
    ...
    constructor(
        ...
        me.registerMessageCmp["Mobile"] = mobileMessageService;
        //me.start();
    }
    ...
    handleClose() {
        ...
        if(!me.isReconnectioned){
            ...
            this.events.publish('order:hold-pop-view');
        }
    }
    handleError() {
        let me = this;
    ...
    // 加载数据
    sendLoadDataMessage(data, loadingData: any = { isShowing: true, content: "正在处理中...", duration: this.appConstants.REQ_TIMEOUT }) { }
    // 登录操作
    sendLoginMessage(data, loadingData: any = { isShowing: true, content: "正在处理中...", duration: this.appConstants.REQ_TIMEOUT }) { }
    sendObserveMessage(eventName, data, loadingData: any = { isShowing: true, content: "正在处理中...", duration: this.appConstants.REQ_TIMEOUT, timeOut: 0 }) {
    ...
    sendDefaultMessage(messageData: any) {
        let me = this;
        messageData.msgType = "Mobile";  // 点菜宝都是Mobile类型
    ...
    saveSwapInfo(swapData, callback) {
        ...
        let swapEventTimeout = setTimeout(function () {
            ...
            eventData.data.data = {isTimeOut: true};
    ...
    doPayMoney(data){
        return Observable.create((observable)=>{
            this.sendObserveMessage("PAYMENT", data).subscribe(function (res) {
                observable.next(res);
            });
        })
    }
    ...
    doLookSingle(data){
        return Observable.create((observable)=>{
            this.sendObserveMessage("PAYQUERY", data).subscribe(function (res) {
                observable.next(res);
            });
        })
    }
    ...
    doPaying(data){
        return Observable.create((observable)=>{
            this.sendObserveMessage("PAYING", data).subscribe(function (res) {
                observable.next(res);
            });
        })
    }
    ...
    isSpecialOrder(data){
        return Observable.create((observable)=>{
            this.sendObserveMessage("QUERYPAYORDERID", data).subscribe(function (res) {
                observable.next(res);
            });
        })
    }
    ...
    addCustomerList(data){
        return Observable.create((observable)=>{
            this.sendObserveMessage("ADDCUSTOMER", data).subscribe(function (res) {
                observable.next(res);
            });
        })
    }
    ...
    getCustomerGrade(data){
        return Observable.create((observable)=>{
            this.sendObserveMessage("QUERYCUSTOMERGRADE",data).subscribe(function (res) {
                observable.next(res);
            });
        })
    }
    ...
    getPrinterInfo(data){
        return Observable.create((observable)=>{
            this.sendObserveMessage("QUERYPRINTER",data).subscribe(function (res) {
                observable.next(res);
            });
        })
    }
    ...
    /* 会员充值 */
    customerRecharge(data){
        return Observable.create((observable)=>{
            this.sendObserveMessage("CUSTOMERRECHARGE",data).subscribe(function (res) {
                observable.next(res);
            });
        })
    }
    /* 获取商品单位 */
    getCommodityUnit(data){
        return Observable.create((observable)=>{
            this.sendObserveMessage("GETCOMMODITYUNIT",data).subscribe(function (res) {
                observable.next(res);
            });
        })
    }
    ...
    /* 获取厨房打印机 */
    getKitchenPrinter(data){
        return Observable.create((observable)=>{
            this.sendObserveMessage("GETKITCHENPRINTER",data).subscribe(function (res) {
                observable.next(res);
            });
        })
    }
    ...
    getNoCodeGood(){
        return Observable.create((observable)=>{
            this.sendObserveMessage("GETNOCODEGOOD",{}).subscribe(function (res) {
                observable.next(res);
            });
        })
    }
    ...
    /* 获取退菜原因 */
    getReturnReason(data){
        return Observable.create((observable)=>{
            this.sendObserveMessage("RETURNREASON",data).subscribe(function (res) {
                observable.next(res);
            });
        })
    }
    ...
    /* 调单 */
    queryCustomerRecharge(data){
        return Observable.create((observable)=>{
            this.sendObserveMessage("QUERYCUSTOMERRECHARGE",data).subscribe(function (res) {
                observable.next(res);
            });
        })
    }

    /* 添加临时菜 ADDTEMPORARYDISH */
    addTemporaryDish(data){
        return Observable.create((observable)=>{
            this.sendObserveMessage("ADDTEMPORARYDISH",data).subscribe(function (res) {
                observable.next(res);
            });
        })
    }
