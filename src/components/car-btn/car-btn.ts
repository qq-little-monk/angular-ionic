...
export class CarBtnComponent {
  ...
  constructor(public woShopService: WoShopService,
  ...
  sub() {
    if (this.salesDetail.salesQty <= this.salesDetail.minCount) {
      ...
      // return;
      this.woShopService.subToCar(this.salesDetail, this.salesDetail.salesQty);
    }
    this.woShopService.subToCar(this.salesDetail);
  }
}
